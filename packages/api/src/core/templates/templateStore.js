import template01A from './definitions/Template%20%231-A.json' with { type: 'json' };
import template01B from './definitions/Template%20%231-B.json' with { type: 'json' };
import template01C from './definitions/Template%20%231-C.json' with { type: 'json' };
import template02A from './definitions/Template%20%232-A.json' with { type: 'json' };
import template02B from './definitions/Template%20%232-B.json' with { type: 'json' };
import template03A from './definitions/Template%20%233-A.json' with { type: 'json' };
import template04A from './definitions/Template%20%234-A.json' with { type: 'json' };
import template05A from './definitions/Template%20%235-A.json' with { type: 'json' };
import template05B from './definitions/Template%20%235-B.json' with { type: 'json' };
import template07A from './definitions/Template%20%237-A.json' with { type: 'json' };
import template11A from './definitions/Template%20%2311-A.json' with { type: 'json' };
import template1 from './definitions/Template%20%231.json' with { type: 'json' };
import template2 from './definitions/Template%20%232.json' with { type: 'json' };
import template3 from './definitions/Template%20%233.json' with { type: 'json' };
import template4 from './definitions/Template%20%234.json' with { type: 'json' };
import template5 from './definitions/Template%20%235.json' with { type: 'json' };
import template6 from './definitions/Template%20%236.json' with { type: 'json' };
import template7 from './definitions/Template%20%237.json' with { type: 'json' };
import template8 from './definitions/Template%20%238.json' with { type: 'json' };
import template9 from './definitions/Template%20%239.json' with { type: 'json' };
import template10 from './definitions/Template%20%2310.json' with { type: 'json' };
import template11 from './definitions/Template%20%2311.json' with { type: 'json' };
import template12 from './definitions/Template%20%2312.json' with { type: 'json' };
import template13A from './definitions/Template%20%2313-A.json' with { type: 'json' };
import template13B from './definitions/Template%20%2313-B.json' with { type: 'json' };
import template13C from './definitions/Template%20%2313-C.json' with { type: 'json' };
import template14 from './definitions/Template%20%2314.json' with { type: 'json' };
import template15 from './definitions/Template%20%2315.json' with { type: 'json' };
